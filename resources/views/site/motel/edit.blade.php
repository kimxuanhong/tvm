...
<section class="content container">
  ...
  <h1>Cập nhật thông tin nhà trọ</h1>
  <hr>
  <div class="row">
    <div class="col-md-12">
          ...
          <div class="col-lg-3">
            <div class="form-group">
              ...
              <select name="category" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                ...
                @if($category->kind==2)
                <option {{$category->id=$motel->category_id ? "selected": ""}} value="{{$category->id}}">{{$category->name}}</option>
                @endif
                @endforeach
              </select>
            </div>
          ...
          <div class="col-lg-4">
            <div class="form-group">
              ...
              <select name="district" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                ...
                <option {{$district->id=$motel->district_id ? "selected": ""}} value="{{$district->id}}">{{$district->name}} - {{$district->province->name}}</option>
                @endforeach
              </select>
            </div>
          </div>
